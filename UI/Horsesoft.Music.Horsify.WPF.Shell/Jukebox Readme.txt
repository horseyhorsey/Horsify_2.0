...
Sidebar Menus:
	...
	History	 = Filter by most played, added date..... < Not sure if dates are working, Sqlite thing needs looking at.

Options:
	Is an old menu and probably will disappear or be remade.
	Would be nice to have the database stats back. (TODO)


Search Songs View:
	Top left blue boxes change the item template.
