--
-- File generated with SQLiteStudio v3.1.1 on Mon Nov 19 16:36:26 2018
--
...
-- Table: FiltersSearch
CREATE TABLE FiltersSearch (Id INTEGER PRIMARY KEY NOT NULL, Name STRING NOT NULL UNIQUE, MaxAmount INTEGER, RandomAmount INTEGER, SearchFilterContent STRING NOT NULL);
...
-- Table: SavedDjHorsify
CREATE TABLE SavedDjHorsify (Id INTEGER PRIMARY KEY NOT NULL, "Or" STRING, "And" STRING, "Not" STRING, Rating STRING);
